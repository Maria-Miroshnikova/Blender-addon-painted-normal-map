...
2. См. ограничения по каждому из режимов генерации в подробной инструкции: [подробная инструкция](instruction.md)
3. Вдоль мест склейки карты нормалей штрихи обрезаются, это место нужно покрывать штрихами вручную
