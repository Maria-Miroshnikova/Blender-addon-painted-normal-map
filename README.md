...
[![видео-демонастрация работы в режиме генерации кривых на основе топологии сетки модели](demo/youtube_random_method_preview.png)](https://www.youtube.com/watch?v=Ko7MAN5VHLs)
- Режим генерацирии случайных штрихов (для перехода кликните на картинку)
- [![видео-демонастрация работы в режиме генерации случайных штрихов](demo/youtube_faceloop_method_preview.png)](https://www.youtube.com/watch?v=EL3dKOMGTC8)
