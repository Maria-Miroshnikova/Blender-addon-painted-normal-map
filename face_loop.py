...
def main():
    ...
    process_faces_from_loop_em(faces_in_loop, change_direction_face, 0, bm, strokes_bm)

    for face in faces_in_loop:
        face.select = True

    (faces_in_loop, change_direction_face) = collect_face_loop(next_edge)
    process_faces_from_loop_em(faces_in_loop, change_direction_face, 0.1, bm, strokes_bm)
